...
class Order(db.Model):
    ...
    order_number: so.Mapped[str] = so.mapped_column(sa.String(255), nullable=False, default="")
    detail_number: so.Mapped[str] = so.mapped_column(sa.String(255), nullable=False, default="")
    ...
    service_number: so.Mapped[str] = so.mapped_column(sa.String(255), nullable=False, default="")
    service_card_number: so.Mapped[str] = so.mapped_column(
        sa.String(255), nullable=False, default=""
    )
    quote_number: so.Mapped[str] = so.mapped_column(sa.String(255), nullable=False, default="")
    purchase_order_number: so.Mapped[str] = so.mapped_column(
        sa.String(255), nullable=False, default=""
    )
